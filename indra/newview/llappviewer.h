...
const S32 AGENT_UPDATES_PER_SECOND  = 45; // Value derived experimentally to avoid Input Delays with latest PBR-Capable Viewers when viewer FPS is highly volatile.
